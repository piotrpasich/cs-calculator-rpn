...
namespace Kalkulator
{
    class RPNCalculator
    {
        ...
        {
            Parser p = new Parser();
            List<Element> parsedCalculations = p.Parse(s);
            InfixToPostfixConverter converter = new InfixToPostfixConverter();
            parsedCalculations = converter.ConvertFromInfixToPostFix(parsedCalculations);

            PostFixCalculator pfe = new PostFixCalculator();
            return pfe.Calculate(parsedCalculations);
        }
    }
    class rpn
    {
    ...
    public class PostFixCalculator
    {
        ...
        public Double Calculate(List<Element> e)
        {
